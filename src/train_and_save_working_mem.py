...
def train_and_save_working_memory_capacity(
    model: nn.Module,
...
def run_working_memory_capacity_analysis_benchmark(config_path: str):
    ...
    for model_name, model in models.items():
        ...
        (
            ...
            val_losses,
            training_time,
        ) = train_and_save_working_memory_capacity(
            model,
            train_loader,
            val_loader,
            epochs,
...
if __name__ == "__main__":
    ...
    run_working_memory_capacity_analysis_benchmark(args.config)
